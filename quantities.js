...
(function (root, factory) {
  ...
  var UNITS = {
    ...
    "<sqkm>":[["square kilometers","square kilometer", "sqkms"], 1000000, "area", ["<meter>","<meter>"]],
    ...
    "<people>" : [["people", "person"], 1, "counting", ["<each>"]],
  ...
  */
  ...
  Qty.prototype = {
    ...
    // Simplified output for JSON
    toJSON: function() { return {scalar: this.scalar, unit: this.units()}; },
    ...
    */
    ...
    toString: function(target_units_or_sig_figs_or_prec, sig_figs) {
      var target_units;
      if(typeof target_units_or_sig_figs_or_prec === "number") {
        sig_figs = target_units_or_sig_figs_or_prec;
      }
      else if(typeof target_units_or_sig_figs_or_prec === "string") {
        target_units = target_units_or_sig_figs_or_prec;
      }
      else if(target_units_or_sig_figs_or_prec instanceof Qty) {
        return this.toPrec(target_units_or_sig_figs_or_prec).toString(sig_figs);
      }

      var out;
      if(!sig_figs && this.output[target_units]) {
      ...
      var out_scalar = sig_figs !== undefined ? parseFloat(out.scalar.toPrecision(sig_figs)) : out.scalar;
      out_scalar = numberWithCommas(out_scalar); 
  ...
  // Comma notation for large numbers
